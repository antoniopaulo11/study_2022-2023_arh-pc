...
операндами удалить один операнд. (рис. [-@fig:014]) Выполнили трансляцию с получением файла
...
с 13 вариантом, полученным при выполнении лабораторной работы № 7.
...
соответствии с вариантом 13 , полученным при выполнении лабораторной
